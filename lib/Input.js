...
var Input = function (_React$Component) {
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      var props = _objectWithoutProperties(_props, ['defaultValue', 'placeholder', 'id', 'type', 'label', 'children', 'validate', 'onChange', 'error']);
      ...
      var htmlLabel = label ? _react2.default.createElement(
        'label',
        { className: (0, _classnames2.default)(labelClasses), htmlFor: id, 'data-error': error },
        label
      ) : null;
